  ...
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium cursor-pointer transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        brand:
          "bg-brand text-primary-foreground shadow-[var(--shadow-glow)] hover:bg-brand-hover hover:-translate-y-0.5",
        soft: "border border-border bg-surface text-foreground shadow-[var(--shadow-soft)] hover:border-brand/40 hover:-translate-y-0.5 hover:text-brand",
      },
      size: {
